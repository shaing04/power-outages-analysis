...
<div style="width: 100%; margin: 0 auto;">
  <iframe src="assets\agg_summary_table.html" width="100%" height="200" frameborder = "0"></iframe>
</div>

We also wanted to see the number of times each region experienced a specific type of power outage. 
<div style="width: 100%; margin: 0 auto;">
  <iframe src="assets/pivot_table_year.html" width="100%" height="400" frameborder = "0"></iframe>
</div>
